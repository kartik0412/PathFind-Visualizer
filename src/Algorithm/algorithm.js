...
function algorithm(startNode, endNode, grid, value, allowDiagnols) {
	if (value === 1) return bfs(startNode, endNode, grid, allowDiagnols);
	else if (value === 2) return dijkstra(startNode, endNode, grid, allowDiagnols);
	else if (value === 3) return astar(startNode, endNode, grid, allowDiagnols);
	else if (value === 4) return greedybfs(startNode, endNode, grid, allowDiagnols);
